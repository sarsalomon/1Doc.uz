import { Button, Modal, Form, Row, Col, Carousel, Tabs, Tab } from "react-bootstrap";
...
import { ADMIN_DASHBOARD_ROUTE, HOME_ROUTE, REGISTRATION_ROUTE, USER_DASHBOARD_ROUTE } from "../utils/consts";
...
import CertificateImage from "./../assets/components/CertificateImage";
...
const Home = observer(() => {
    ...
    const [director, seDirector] = useState(false);

    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);

    const directorClose = () => seDirector(false);
    const directorShow = () => seDirector(true);
    ...
    const tabsData = [
        {
            ...
            listItems: ["General:Home:Tabs:Contract_text_one", "General:Home:Tabs:Contract_text_two", "General:Home:Tabs:Contract_text_three", "General:Home:Tabs:Contract_text_four"],
        },
        {
            eventKey: "arizalar",
            ...
            listItems: ["General:Home:Tabs:Application_text_one", "General:Home:Tabs:Application_text_two", "General:Home:Tabs:Application_text_three", "General:Home:Tabs:Application_text_four"],
        },
        {
            ...
            listItems: ["General:Home:Tabs:Document_text_one", "General:Home:Tabs:Document_text_two", "General:Home:Tabs:Document_text_three", "General:Home:Tabs:Document_text_four"],
        },
        {
            ...
            listItems: ["General:Home:Tabs:Appeal_text_one", "General:Home:Tabs:Appeal_text_two", "General:Home:Tabs:Appeal_text_three"],
        },
        {
            eventKey: "imzo",
            ...
            listItems: ["General:Home:Tabs:Signature_text_one", "General:Home:Tabs:Signature_text_two", "General:Home:Tabs:Signature_text_three"],
        },
        {
            eventKey: "sms",
            ...
            listItems: ["General:Home:Tabs:Sms_text_one", "General:Home:Tabs:Sms_text_two"],
        },
        {
            eventKey: "ocr",
            ...
            listItems: ["General:Home:Tabs:OCR_text_one", "General:Home:Tabs:OCR_text_two"],
        },
        {
            eventKey: "ai",
            ...
            listItems: ["General:Home:Tabs:AI_text_one", "General:Home:Tabs:AI_text_two"],
        },
    ];
        ...
        <>
            <div>
                <header>
                    <nav>
                        ...
                        <div className="btns d-flex">
                            ...
                            <button className="btn btn-outline-primary login-btn" onClick={handleShow}>
                    ...
                    <div className="header-content">
                        <ReactTyped className="header-title" strings={[t("General:Home:Header:text_two")]} typeSpeed={30} backSpeed={60} loop />
                        <p>{t("General:Home:Header:Header_description")}</p>
                        <div className="btns d-flex">
                            <a className="btn btn-primary prices-btn" onClick={() => scrollToElement()}>
                ...
                <section className="tabs">
                    <Tabs defaultActiveKey="shartnomalar" className="d-flex justify-content-center items-content-center">
                        {tabsData.map((tab, index) => (
                            <Tab eventKey={tab.eventKey} key={index} title={t(tab.title)}>
                                <div className="tab-content">
                                    <Row>
                                        <Col md={5}>
                                            <img src={tab.imgSrc} className="img-fluid" alt={tab.imgAlt} />
                                        </Col>
                                        <Col md={6}>
                ...
                <section className="second-slider">
                    <Carousel interval={2000} touch variant="dark" prevIcon={<img src={Carousel_left_icon} />} nextIcon={<img src={Carousel_right_icon} />}>
                ...
                <section className="signing-types">
                    ...
                    <Row className="signing-types-content">
                        <Col md={2} sm={6} xs={6} className="signing-types-col d-flex justify-content-center align-items-center flex-column">
                                ...
                                <Form className="price-types">
                                    {priceInfo.months.map((month, index) => (
                                        <div className={`type-${index + 1}`} key={index}>
                                            <Form.Check inline label={`${month} ${t(priceInfo.month)}`} name={priceInfo.groupName} type="radio" id={`inline-radio-${priceInfo.groupName}-${index}`} defaultChecked={index === 0} />
                                        </div>
                                    ))}
                                </Form>
                                <button className="btn btn-primary">{t(priceInfo.select)}</button>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <footer>
                    <Row>
                        <Col md={3}>
                            ...
                            <ul>
                                <li>
                                    <a href="https://api.1doc.uz/muhim/MA’LUMOTLARNING MAXFIYLIK SIYOSATI 1DOC MCHJ.pdf" target="_blank">
                                        {t("General:Home:Footer:Column_one:Column_one_text_one")}
                                    </a>
                                </li>
                                <li>
                                    <a href="https://api.1doc.uz/muhim/OMMAVIY OFERTA 1doc.uz.pdf" target="_blank">
                                        {t("General:Home:Footer:Column_one:Column_one_text_two")}
                                    </a>
                                </li>
                                <li>
                                    <a onClick={directorShow}>{t("General:Home:Footer:Column_one:Column_one_text_three")}</a>
                                </li>
                            </ul>
                        </Col>
                ...
                <Modal.Body>
                    <Form className="d-flex flex-column">
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Control placeholder={t("General:Auth:passwordPlaceholder")} type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                        </Form.Group>
                        ...
                        <div className="d-grid gap-1">
                            <Button variant="primary" size="lg" className="mt-3 align-self-end" onClick={click}>
            ...
            <Modal className="py-4" show={director} onHide={directorClose} dialogClassName="Signature-modal-90w" backdrop="static" keyboard={false} centered>
                <Modal.Header closeButton>
                    <div className="d-inline align-items-center justify-content-center">
