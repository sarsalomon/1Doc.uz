            ...
            <Navbar expand="lg" className="bg-body-tertiary">
                <Container fluid>
                    <NavLink to={USER_DASHBOARD_ROUTE}>
                        <Navbar.Brand>OneDoc</Navbar.Brand>
                    </NavLink>
                        ...
                        <Nav className="ms-auto me-5">
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    ...
                                    <Dropdown.Item onClick={() => changeLanguage("kr")}>Ўзбек</Dropdown.Item>
                                    <Dropdown.Item onClick={() => changeLanguage("qr")}>Qaraqalpaq</Dropdown.Item>
                                    <Dropdown.Item onClick={() => changeLanguage("qrkr")}>Қарақалпақ</Dropdown.Item>
                                </Dropdown.Menu>
